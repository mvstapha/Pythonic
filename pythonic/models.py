...
class User(db.Model, UserMixin):
    ...
    lessons = db.relationship('Lesson', backref='author', lazy=True) # Mean the lesson that this user have made (like adding a "Author" Column to "Lesson" class)
...
class Lesson(db.Model):
    ...
    thumbnail = db.Column(db.String(20), nullable=False, default='default_thumbnail.jpg') #default= if server didn't find the image, will use a default one
